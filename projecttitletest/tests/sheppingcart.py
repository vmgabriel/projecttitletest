"""projecttitletest - Sheppingcart - Test"""

# Modules
from django.test import TestCase
from datetime import datetime
from projecttitletest.models.sheppingcart import Sheppingcart
...
class SheppingcartTestCase(TestCase):
    ...
    def test_should_get_one_data(self):
        ...
        sheppingcart_t_name = Sheppingcart.objects.filter(t_name__icontains="Update")
        self.assertEqual(sheppingcart_t_name.count(), 3)

    def test_should_get_none_data(self):
        current_time = datetime.strptime("2020-12-18 3:11:09", "%Y-%m-%d %H:%M:%S")
        sheppingcart_t_name = Sheppingcart.objects.filter(t_name__icontains="2")
        self.assertEqual(sheppingcart_t_name.count(), 0)
    ...
    def test_put_data(self):
        ...
        data.save()
        self.assertEqual(data.t_name, "Update")
