...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("projecttitletests:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("projecttitletests:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("projecttitletests:users")
...
def delete_user_view(request, pk):
    ...
    user.delete()
    return redirect("projecttitletests:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("projecttitletests:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("projecttitletests:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("projecttitletests:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("projecttitletests:sheppingcarts")
